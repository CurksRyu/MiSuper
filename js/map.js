...
function initMap() {
    const myLatLng = { lat: -20.25685, lng: -70.12436 };
  ...
  window.setInterval(getPosition,12000000);
}
...
function errorHandler(err){
  if(err.code == 1){
    alert("Acceso denegado a la ubicaci贸n");
  }else if(err.code ==2){
    alert("No se pudo encontrar tu ubicaci贸n");
  }
}
